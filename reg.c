...
static int add_vector_address(int vector_id,unsigned long vector_address, struct module *vector_module){
	int ret_val = 0;
...
int register_syscall(int vector_id, unsigned long vector_address, struct module* vector_module) {
	int ret_val = 0;
